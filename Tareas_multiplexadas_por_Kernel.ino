...
void crearTareas(void){
  ...
  xTaskCreate(TaskW,   /* Task function. */
              "ledblanco",     /* name of task. */
              memoria,       /* Stack size of task */
              NULL,        /* parameter of the task */
              1,           /* priority of the task */
              &blanco);      /* Task handle to keep track of created task */

  xTaskCreate(TaskR,   /* Task function. */
              "ledrojo",     /* name of task. */
              memoria,       /* Stack size of task */
              NULL,        /* parameter of the task */
              1,           /* priority of the task */
              &rojo);      /* Task handle to keep track of created task */

  xTaskCreate(TaskG,   /* Task function. */
              "ledverde",     /* name of task. */
              memoria,       /* Stack size of task */
              NULL,        /* parameter of the task */
              1,           /* priority of the task */
              &verde);      /* Task handle to keep track of created task */ 
